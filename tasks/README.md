# Tasks (editorial backlog)

Work items for developing the open letter. **Not site content.**

- Astro only loads Markdown from `src/content/sections/` (see `src/content.config.ts`).
